...
b8 platform_startup(
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "oko_window_class", application_name,
...
void platform_get_vulkan_required_extension_names(const char ***names_darray) {
    darray_push(*names_darray, &"VK_KHR_win32_surface");
}

b8 platform_create_vulkan_surface(platform_state *platform_state, struct vulkan_context *context) {
    // Simply cold-cast to the known type
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    switch (msg) {
        ...
        case WM_SIZE: {
            ...
            // Fire the event. The application layer should pick this up, bot not handle it
