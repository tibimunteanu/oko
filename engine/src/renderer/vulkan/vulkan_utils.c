...
const char* vulkan_result_string(VkResult result, b8 get_extended) {
    ...
    case VK_TIMEOUT:
        return !get_extended ? "VK_TIMEOUT"
                             : "VK_TIMEOUT A wait operation has not "
    ...
    case VK_INCOMPLETE:
        return !get_extended ? "VK_INCOMPLETE"
                             : "VK_INCOMPLETE A return array was too small "
                               "for the result";
    ...
    case VK_THREAD_DONE_KHR:
        return !get_extended ? "VK_THREAD_DONE_KHR"
                             : "VK_THREAD_DONE_KHR A deferred operation is "
                               "not complete but there is no work "
                               "remaining to assign to additional threads.";
    case VK_OPERATION_DEFERRED_KHR:
        return !get_extended ? "VK_OPERATION_DEFERRED_KHR"
                             : "VK_OPERATION_DEFERRED_KHR A deferred "
                               "operation was requested and at least some "
    ...
    case VK_PIPELINE_COMPILE_REQUIRED_EXT:
        return !get_extended ? "VK_PIPELINE_COMPILE_REQUIRED_EXT"
                             : "VK_PIPELINE_COMPILE_REQUIRED_EXT A "
                               "requested pipeline creation would have "
                               "required compilation, but the application "
    ...
    case VK_ERROR_OUT_OF_DEVICE_MEMORY:
        return !get_extended ? "VK_ERROR_OUT_OF_DEVICE_MEMORY"
                             : "VK_ERROR_OUT_OF_DEVICE_MEMORY A device "
                               "memory allocation has failed.";
    case VK_ERROR_INITIALIZATION_FAILED:
        return !get_extended
                 ? "VK_ERROR_INITIALIZATION_FAILED"
                 : "VK_ERROR_INITIALIZATION_FAILED Initialization of an "
                   "object could not be completed for "
    ...
    case VK_ERROR_MEMORY_MAP_FAILED:
        return !get_extended ? "VK_ERROR_MEMORY_MAP_FAILED"
                             : "VK_ERROR_MEMORY_MAP_FAILED Mapping of a "
    ...
    case VK_ERROR_TOO_MANY_OBJECTS:
        return !get_extended ? "VK_ERROR_TOO_MANY_OBJECTS"
                             : "VK_ERROR_TOO_MANY_OBJECTS Too many objects "
                               "of the type have already been created.";
    ...
    case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
        return !get_extended
                 ...
                 : "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR The display used "
                   "by a swapchain does not use the same presentable "
                   "image layout, or is incompatible in a way that "
                   "prevents sharing an image.";
    case VK_ERROR_INVALID_SHADER_NV:
        return !get_extended
                 ? "VK_ERROR_INVALID_SHADER_NV"
                 : "VK_ERROR_INVALID_SHADER_NV One or more shaders "
                   "failed to compile or link. More details are reported "
                   "back to the application via VK_EXT_debug_report if "
                   "enabled.";
    ...
    case VK_ERROR_INVALID_DEVICE_ADDRESS_EXT:
        return !get_extended ? "VK_ERROR_INVALID_DEVICE_ADDRESS_EXT"
                             : "VK_ERROR_INVALID_DEVICE_ADDRESS_EXT A "
                               "buffer creation failed because the "
    ...
    case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
        return !get_extended
                 ...
                 : "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT An "
                   ...
                   "failed as it did not have exlusive full-screen "
                   "access. This may occur due to "
                   "implementation-dependent reasons, outside of the "
...
b8 vulkan_result_is_success(VkResult result) {
    ...
    // case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS:
    case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
    case VK_ERROR_UNKNOWN: return false;
    }
}